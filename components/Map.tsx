...
const Map: React.FC<MapProps> = ({ latitude, longitude }) => {
  ...
  const mapUrl = `https://maps.googleapis.com/maps/api/staticmap?center=${latitude},${longitude}&zoom=15&size=400x400&maptype=roadmap&markers=color:red%7C${latitude},${longitude}&key=AIzaSyDtOoTc6JffQ6dJibMV0tZ-d7YenKdhM1c`;
