    ...
    <div className="relative shrink-0">
      ...
      >
        <div className="relative flex items-center gap-2 h-14 border-b ">
          <svg xmlns="http://www.w3.org/2000/svg" className="ml-3 shrink-0" viewBox="0 0 64 64" width="28" height="28">
          ...
          <label
            ...
            className="toggle-close ml-auto mr-2 inline-flex h-6 w-6 cursor-pointer items-center justify-center rounded border border-gray-300 bg-white text-blue-600 hover:bg-blue-50"
            aria-label="Hide secondary panel"
            title="Hide secondary panel"
          >
            <PanelLeftClose size={16} />
          </label>
          <label
            htmlFor="secondary-sidebar-toggle"
            className="toggle-open absolute left-16 top-1/2 z-30 hidden h-6 w-6 -translate-y-1/2 cursor-pointer items-center justify-center rounded border border-gray-300 bg-white text-blue-600 hover:bg-blue-50"
        ...
        <div className="relative flex h-[calc(100%-56px)]">
          ...
          {isSecondaryCollapsed ? (
            <>
              <div className="collapsed-panel-documents absolute left-16 top-0 z-20 h-full w-64 border-r bg-white shadow-lg opacity-0 pointer-events-none -translate-x-2 transition-[opacity,transform] duration-200">
                <SecondarySidebar
                  active="documents"
              ...
              <div className="collapsed-panel-contacts absolute left-16 top-0 z-20 h-full w-64 border-r bg-white shadow-lg opacity-0 pointer-events-none -translate-x-2 transition-[opacity,transform] duration-200">
                <SecondarySidebar
                  active="contacts"
                  activeSecondarybar={activeSecondarybar}
                  secondaryActive={setActiveSecondarybar}
              ...
              <div className="collapsed-panel-account absolute left-16 top-0 z-20 h-full w-64 border-r bg-white shadow-lg opacity-0 pointer-events-none -translate-x-2 transition-[opacity,transform] duration-200">
                <SecondarySidebar
                  active="account"
                  activeSecondarybar={activeSecondarybar}
                  secondaryActive={setActiveSecondarybar}
