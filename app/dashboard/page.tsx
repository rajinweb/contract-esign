    ...
    <>
      <header className="flex border-b">
          <div className="flex items-center gap-2"> 
            <svg xmlns="http://www.w3.org/2000/svg" className="ml-3" viewBox="0 0 64 64" width="32" height="32">
           ...
           <h1 className='text-2xl text-blue-600 font-semibold w-64'>DocYouSign<sup className='text-sm'>TM</sup></h1>
          </div>
          <div className='flex items-center justify-end gap-4 px-4 py-2 w-full'>
          {isTemplateView ? (
            <TemplateSearch
      ...
      <div className="p-4 w-full overflow-auto bg-gray-100">
        {showUploadZone ? (
          <UploadZone />
        ) : (
          <>
